...
echo"<body background=restaurant2.jpg>";
echo"<div class=background>";
 echo"<h1><marquee behavior=slide><font size=5 color=#4d004d><font size=6>M</font>ULTISPICE, <font size=6>K</font>ARVENAGAR, <font size=6>P</font>UNE</marquee></font></h1><br>";
echo"<img src=r.png alt=The Pulpit Rock width=60 height=60 margin=1px;align=right>";
echo"<ul>";
        echo"<li><a href=main.html>MAIN</a></li>";
        echo"<li><a href=msmap.html>MAP</a></li>";
        echo"<li><a href=restaurant2menu1.php>MENU</a></li>";
	...
	echo"<form method=post action=place_order2.php>";
 	...
 	echo"<tr>";
  	...
  	echo"<tr>";
		...
		echo"<td><img src=22.JPG alt=The Pulpit Rock width=200 height=150 align=left margin=1px;align=center></td>";
    		echo"<td><font size=5>VEG MANCHOW SOUP </font><br> <br><font size=3> A soup prepared with various <br> veggies flavoured  			with soy sauce,<br>garlic and chilli peppers.</font></td>";
 	...
 	echo"</tr>";
  	echo"<tr>";
  		echo"<td><input type=checkbox name=check_list[] value=22 id=a></td>";
    		echo"<td><img src=veg.png alt=The Pulpit Rock width=40 height=40 margin=1px;align=center></td>";
		echo"<td><img src=24.jpg alt=The Pulpit Rock width=200 height=150 align=left margin=1px;align=center></td>";
    		echo"<td><font size=5>CHOLE BHATURE</font><br><br><font size=3>A tasty combination of chana masala <br>and soft fried 			white<br> bread.</font></td>";
  	...
  	echo"<tr>";
   		echo"<td><input type=checkbox name=check_list[] value=23></td>";
    		echo"<td><img src=veg.png alt=The Pulpit Rock width=40 height=40 margin=1px;align=center></td>";
		echo"<td><img src=25.jpg alt=The Pulpit Rock width=200 height=150 align=left margin=1px;align=center></td>";
    		echo"<td><font size=5>ALFREDO PASTA</font><br><br><font size=3>A tasty pasta made in red sauce  <br>containing 			herbs,veggies<br> and cheese.</font></td>";
