	...
	echo"<form method=post action=place_order2.php>";
 	...
 	echo"<tr>";
  	...
  	echo"<tr>";
		...
		echo"<td><img src=h5m1.jpg alt=The Pulpit Rock width=200 height=150 align=left margin=1px;align=center></td>";
    		echo"<td><font size=5>RAINBOW PASTRY</font><br> <br><font size=3> A soup prepared with various <br> veggies flavoured  			with soy sauce,<br>garlic and chilli peppers.</font></td>";
 	...
 	echo"</tr>";
  	echo"<tr>";
  		echo"<td><input type=checkbox name=check_list[] value=22 id=a></td>";
    		echo"<td><img src=veg.png alt=The Pulpit Rock width=40 height=40 margin=1px;align=center></td>";
		echo"<td><img src=h5m2.jpg alt=The Pulpit Rock width=200 height=150 align=left margin=1px;align=center></td>";
    		echo"<td><font size=5>CHOCOLATE TRUFFLE</font><br><br><font size=3>A tasty combination of chana masala <br>and soft fried 			white<br> bread.</font></td>";
  	...
  	echo"<tr>";
   		echo"<td><input type=checkbox name=check_list[] value=23></td>";
    		echo"<td><img src=veg.png alt=The Pulpit Rock width=40 height=40 margin=1px;align=center></td>";
		echo"<td><img src=h5m3.jpg alt=The Pulpit Rock width=200 height=150 align=left margin=1px;align=center></td>";
    		echo"<td><font size=5>BLUEBERRY CUPCAKE</font><br><br><font size=3>A tasty pasta made in red sauce  <br>containing 			herbs,veggies<br> and cheese.</font></td>";
